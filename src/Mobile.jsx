            ...
            <div className="row feature-icons" data-aos="fade-up">
                <div className="row">
                    ...
                    <div className="col-lg-12 pt-4 pt-lg-0 content order-lg-0" data-aos="zoom-in-up">
                        ...
                        <h4 className="text-center">We have proved our expertise in each and every field of app development like:</h4>
                        ...
                        <p className="text-center"> Technology is changing at a very fast pace nowadays and so we also keep updating ourselves and work on the latest
